...
- [Genocs.WebApi-Agent-Documentation.md](./Genocs.WebApi-Agent-Documentation.md) — endpoint DSL whose
  `WebApiEndpointDefinitions` is consumed by `WebApiDocumentFilter`
- [Genocs.Core-Agent-Documentation.md](./Genocs.Core-Agent-Documentation.md) — `IGenocsBuilder` foundation
