...
public static class Extensions
{
    ...
    public static IServiceCollection AddFinbuckleMultiTenancyWithEfCoreStore(this IServiceCollection services)
    {
        ...
        // The tenant store is pinned to SQL Server by design: this package targets SQL Server-backed multitenancy.
        return services
            .AddDbContext<TenantDbContext>((p, m) =>
            {
                ...
                new SqlServerDbProvider().Configure(m, databaseSettings);
            })
