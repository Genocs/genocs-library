...
Redis storage integration for Genocs saga state management. Supports `net10.0`, `net9.0`, and `net8.0`.
...
Use this package to persist saga state and correlation data in Redis when used with `Genocs.Saga`.
