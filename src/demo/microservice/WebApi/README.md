...
```bash
dotnet run --project src/demo/microservice/WebApi/Host.csproj
```
...
dotnet dotnet-ef migrations list \
  --project src/demo/microservice/WebApi/Host.csproj \
  --startup-project src/demo/microservice/WebApi/Host.csproj \
...
dotnet dotnet-ef migrations add <MigrationName> \
  --project src/demo/microservice/Domain.EFCore/Domain.EFCore.csproj \
  --startup-project src/demo/microservice/WebApi/Host.csproj \
  --context BookStoreDbContext \
...
- `src/demo/microservice/WebApi/Genocs.Core.Demo.HelloWorld.http`
