...
Redis-backed persistence helpers and repository integration. Supports `net10.0`, `net9.0`, and `net8.0`.
...
Use this package to integrate Redis-backed persistence components in Genocs applications.
