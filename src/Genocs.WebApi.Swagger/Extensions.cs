...
public static class Extensions
{
    ...
    public static IGenocsBuilder AddWebApiSwaggerDocs(this IGenocsBuilder builder, Func<IOpenApiSettingsBuilder, IOpenApiSettingsBuilder> buildOptions)
        => builder.AddWebApiSwaggerDocs(b => b.AddSwaggerDocs(buildOptions));

    public static IGenocsBuilder AddWebApiSwaggerDocs(this IGenocsBuilder builder, OpenApiSettings options)
