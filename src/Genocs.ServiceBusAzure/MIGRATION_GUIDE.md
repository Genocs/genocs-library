...
This guide explains how to upgrade your application when moving from the legacy `Microsoft.Azure.ServiceBus` SDK to the modern `Azure.Messaging.ServiceBus` SDK used by **Genocs.ServiceBusAzure**.
...
1. **Update the Genocs.ServiceBusAzure package** to the latest version.
